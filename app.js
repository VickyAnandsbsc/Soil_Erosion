...
var add = ui.Button('Click Here for Display');

var blog_label = ui.Label({value: '❓Vicky Anand (SFEDU)️', style: {fontWeight: 'bold'}})
.setUrl('https://www.researchgate.net/profile/Vicky-Anand-5');
...
var title_label = ui.Label({
  value: "Soil Erosion Map (Bootstrapped Approach)",
  style: {
    fontWeight: 'bold',
    fontSize: '18px',
    margin: '0 0 4px 0',
...
function renderDateRange(date_range){
  ...
  drawing_tools.clear(); // Clean out previous drawing tools for the default India inputs.
